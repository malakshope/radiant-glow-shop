...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-2xl font-bold">تعذّر تحميل الصفحة</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          حدث خطأ ما. حاول التحديث أو العودة للرئيسية.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "إدارة طلبيات المتجر" },
      { name: "description", content: "نظام عربي بسيط وسريع لتسجيل الطلبيات وتأكيدها وأرشفتها." },
      { property: "og:title", content: "إدارة طلبيات المتجر" },
      { property: "og:description", content: "سجّل الطلبيات، أكّدها، أرشفها واحذفها نهائيًا عند الحاجة." },
